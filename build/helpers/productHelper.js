...
var module = new productModel_1.Model_OF_Product();
var create = function (req, _res) { return __awaiter(void 0, void 0, void 0, function () {
    var productdata, newProduct, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, module.create(productdata)];
            case 2:
                newProduct = _a.sent();
...
var displayAll = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, module.displayAllproducts()];
            case 1:
                products = _a.sent();
                res.json(products);
                return [3 /*break*/, 3];
...
var show = function (_req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, module.showOneProduct(_req.params.id)];
            case 1:
                product = _a.sent();
                console.log(product);
                res.json(product);
...
var update = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var productData, updatedUser, err_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                productData = {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, module.update(productData)];
            case 2:
                updatedUser = _a.sent();
