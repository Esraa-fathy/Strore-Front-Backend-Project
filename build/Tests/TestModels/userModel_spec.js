...
describe("USER MODEL", function () {
    describe("Test CRUD API methods", function () {
        ...
        it(" displayAllusers method ", function () {
            expect(module.displayAllusers).toBeDefined();
        });
        it(" showOneUsr method ", function () {
    ...
    it("Shoud create new user", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, module.create({
                        first_name: "nono",
                        last_name: "Fathy",
                        email: "n@jjsgmail",
                        pass: "test",
    ...
    it("Should display a specefic user", function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, module.showOneUsr("1")];
                case 1:
                    result = _a.sent();
                    expect(result.first_name).toEqual("nono");
                    expect(result.last_name).toEqual("Fathy");
    ...
    it("Should list all of users", function () { return __awaiter(void 0, void 0, void 0, function () {
        var users;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, module.displayAllusers()];
                case 1:
                    users = _a.sent();
